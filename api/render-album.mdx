...
<ParamField path="hash" type="string" required>
  Base64 standard alphabet, no-padding encoding of a `FanRenderRequestData` JSON object. Contains an array of cards and an optional top-level `save_name`. See [Hash encoding](/concepts/hash-encoding).
</ParamField>
